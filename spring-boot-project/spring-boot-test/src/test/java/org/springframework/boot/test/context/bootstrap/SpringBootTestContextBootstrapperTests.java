...
class SpringBootTestContextBootstrapperTests {
	...
	void springBootTestWithANonMockWebEnvironmentAndWebAppConfigurationFailsFast() {
		assertThatIllegalStateException()
				...
				.withMessageContaining(new StringBuilder().append("@WebAppConfiguration should only be used with ").append("@SpringBootTest when @SpringBootTest is configured with a mock web ").append("environment. Please remove @WebAppConfiguration or reconfigure @SpringBootTest.").toString());
	}
