...
public class FreeMarkerAutoConfiguration {
	...
	public void checkTemplateLocationExists() {
		...
		if (locations.stream().noneMatch(this::locationExists)) {
			logger.warn(new StringBuilder().append("Cannot find template location(s): ").append(locations).append(" (please add some templates, ").append("check your FreeMarker configuration, or set ").append("spring.freemarker.checkTemplateLocation=false)").toString());
		}
	}
