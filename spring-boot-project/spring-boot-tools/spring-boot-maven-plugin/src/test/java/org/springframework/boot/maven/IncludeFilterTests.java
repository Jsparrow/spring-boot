...
class IncludeFilterTests {
	...
	void includeSimple() throws ArtifactFilterException {
		IncludeFilter filter = new IncludeFilter(Collections.singletonList(createInclude("com.foo", "bar")));
	...
	void includeClassifier() throws ArtifactFilterException {
		IncludeFilter filter = new IncludeFilter(Collections.singletonList(createInclude("com.foo", "bar", "jdk5")));
